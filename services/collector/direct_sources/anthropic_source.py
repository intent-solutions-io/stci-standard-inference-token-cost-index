"""
Anthropic Direct Source - Official pricing from config file.
"""
...
class AnthropicDirectSource(BaseSource):
    """
    Load Anthropic pricing from local config file.

    Since Anthropic doesn't provide a public pricing API, we maintain
    a YAML config with manually verified pricing from anthropic.com/pricing
    """
    ...
    def fetch(self, target_date: date) -> List[dict]:
        ...
        source_url = config.get("source_url", "https://www.anthropic.com/pricing")
        ...
        for model_id, model_data in models.items():
            ...
            obs = {
                "observation_id": f"obs-{target_date.isoformat()}-anthropic-{model_id}",
