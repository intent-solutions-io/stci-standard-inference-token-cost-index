"""
Google Direct Source - Official pricing from config file.
"""
...
class GoogleDirectSource(BaseSource):
    """
    Load Google Gemini pricing from local config file.

    Since Google doesn't provide a public pricing API, we maintain
    a YAML config with manually verified pricing from cloud.google.com/vertex-ai/generative-ai/pricing
    """
    ...
    def fetch(self, target_date: date) -> List[dict]:
        ...
        source_url = config.get("source_url", "https://cloud.google.com/vertex-ai/generative-ai/pricing")
        ...
        for model_id, model_data in models.items():
            ...
            obs = {
                "observation_id": f"obs-{target_date.isoformat()}-google-{model_id}",
